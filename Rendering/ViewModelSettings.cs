...
public sealed class ViewModelSettings
{
    ...
    public float BaseRightOffset { get; set; } = 0.50f;
    public float BaseRightSwing { get; set; } = 0.03f;
    public float BaseUpOffset { get; set; } = -0.38f;
    public float BaseUpSettle { get; set; } = 0.015f;
    public float BaseForwardOffset { get; set; } = 0.74f;
    public float BaseForwardSwing { get; set; } = 0.03f;

    // Arm direction from camera.
    public float ArmForwardFactor { get; set; } = 0.82f;
    public float ArmRightFactor { get; set; } = -0.84f;
    public float ArmUpFactor { get; set; } = 0.05f;

    // Arm box dimensions.
    public float ArmWidth { get; set; } = 0.10f;
    public float ArmHeight { get; set; } = 0.13f;
    public float ArmLength { get; set; } = 0.46f;

    // Hand placement.
    public float HandForwardOffset { get; set; } = 0.19f;
    public float HandUpOffset { get; set; } = -0.03f;
    ...
    public float ItemSideOffset { get; set; } = -0.02f;
    public float ItemUpOffset { get; set; } = -0.02f;
    public float ItemForwardOffset { get; set; } = 0.08f;

    // Tool placement.
    public float ToolForwardFactor { get; set; } = 0.18f;
    public float ToolRightFactor { get; set; } = 0.84f;
    public float ToolUpFactor { get; set; } = 0.42f;
    public float ToolSideOffset { get; set; } = 0.02f;
    public float ToolUpOffset { get; set; } = -0.02f;
    public float ToolForwardOffset { get; set; } = -0.04f;
    public float ToolWidth { get; set; } = 0.48f;
    public float ToolHeight { get; set; } = 0.76f;
    public float ToolGripRightOffset { get; set; } = 0.02f;
    public float ToolGripUpOffset { get; set; } = 0.12f;
    public float ToolScreenTiltDegrees { get; set; } = 34f;
    public float ToolScreenRightOffset { get; set; } = 0.22f;
    public float ToolScreenUpOffset { get; set; } = 0.20f;
